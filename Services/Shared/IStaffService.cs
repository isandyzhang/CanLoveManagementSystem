...
public interface IStaffService
{
    ...
    /// </summary>
    Task<Staff?> GetStaffByAzureObjectIdAsync(string azureObjectId);

    /// <summary>
    /// 從Azure AD Claims建立員工
    /// </summary>
    Task<Staff> CreateStaffFromAzureAsync(ClaimsPrincipal principal);

    /// <summary>
    /// 從Azure AD Claims更新員工資訊（包含頭像URL）
    /// </summary>
    Task<Staff> UpdateStaffFromAzureAsync(Staff staff, ClaimsPrincipal principal);
    ...
    /// 取得所有員工（僅必要欄位）
    /// </summary>
    Task<List<Staff>> GetAllForListAsync();
