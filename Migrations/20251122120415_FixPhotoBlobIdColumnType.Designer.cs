...
namespace CanLove_Backend.Migrations
{
    ...
    [Migration("20251122120415_FixPhotoBlobIdColumnType")]
    partial class FixPhotoBlobIdColumnType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CanLove_Backend.Infrastructure.Data.Audit.UserActivityLog", b =>
                {
            ...
            modelBuilder.Entity("CanLove_Backend.Infrastructure.Data.History.CaseDetailHistory", b =>
                {
            ...
            modelBuilder.Entity("CanLove_Backend.Infrastructure.Data.History.CaseHistory", b =>
                {
                    b.Property<long>("HistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CanLove_Backend.Infrastructure.Options.Models.FamilyStructureType", b =>
                {
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Basic.Case", b =>
                {
                    ...
                    b.HasOne("CanLove_Backend.Infrastructure.Storage.Blob.BlobStorage", "PhotoBlob")
                        .WithMany()
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseConsultationRecord", b =>
                {
                    ...
                    b.HasOne("CanLove_Backend.Infrastructure.Options.Models.OptionSetValue", "ConsultationMethodValue")
                    ...
                    b.HasOne("CanLove_Backend.Infrastructure.Options.Models.OptionSetValue", "ConsultationTargetValue")
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseDetail", b =>
                {
                    ...
                    b.HasOne("CanLove_Backend.Infrastructure.Options.Models.OptionSetValue", "ContactRelationValue")
                    ...
                    b.HasOne("CanLove_Backend.Infrastructure.Options.Models.FamilyStructureType", "FamilyStructureType")
                        .WithMany("CaseDetails")
                        .HasForeignKey("FamilyStructureTypeId")
                        .HasConstraintName("FK__CaseDetai__famil__08B54D69");

                    b.HasOne("CanLove_Backend.Infrastructure.Options.Models.OptionSetValue", "HelpExperienceValue")
                    ...
                    b.HasOne("CanLove_Backend.Infrastructure.Options.Models.OptionSetValue", "MainCaregiverEduValue")
                    ...
                    b.HasOne("CanLove_Backend.Infrastructure.Options.Models.OptionSetValue", "MainCaregiverMarryStatusValue")
                    ...
                    b.HasOne("CanLove_Backend.Infrastructure.Options.Models.OptionSetValue", "MainCaregiverRelationValue")
                    ...
                    b.HasOne("CanLove_Backend.Infrastructure.Options.Models.Nationality", "ParentNationFather")
                        .WithMany("CaseDetailParentNationFathers")
                        .HasForeignKey("ParentNationFatherId")
                        .HasConstraintName("FK__CaseDetai__paren__09A971A2");

                    b.HasOne("CanLove_Backend.Infrastructure.Options.Models.Nationality", "ParentNationMother")
                        .WithMany("CaseDetailParentNationMothers")
                        .HasForeignKey("ParentNationMotherId")
                        .HasConstraintName("FK__CaseDetai__paren__0A9D95DB");

                    b.HasOne("CanLove_Backend.Infrastructure.Options.Models.OptionSetValue", "SourceValue")
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseFamilyMember", b =>
                {
                    ...
                    b.HasOne("CanLove_Backend.Infrastructure.Options.Models.OptionSetValue", "MemberTypeValue")
                        .WithMany()
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseFamilySpecialStatus", b =>
                {
                    ...
                    b.HasOne("CanLove_Backend.Infrastructure.Options.Models.OptionSetValue", "StatusTypeValue")
                        .WithMany()
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseHqhealthStatus", b =>
                {
                    b.HasOne("CanLove_Backend.Infrastructure.Options.Models.OptionSetValue", "CaregiverRoleValue")
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseSocialWorkerContent", b =>
                {
                    ...
                    b.HasOne("CanLove_Backend.Infrastructure.Options.Models.OptionSetValue", "ResidenceTypeValue")
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseSocialWorkerService", b =>
                {
                    ...
                    b.HasOne("CanLove_Backend.Infrastructure.Options.Models.OptionSetValue", "ServiceTypeValue")
                        .WithMany("CaseSocialWorkerServices")
            ...
            modelBuilder.Entity("CanLove_Backend.Infrastructure.Options.Models.OptionSetValue", b =>
                {
                    b.HasOne("CanLove_Backend.Infrastructure.Options.Models.OptionSet", "OptionSet")
            ...
            modelBuilder.Entity("CanLove_Backend.Infrastructure.Storage.Blob.BlobStorage", b =>
                {
                    b.HasOne("CanLove_Backend.Domain.Staff.Models.Staff", "Uploader")
                        .WithMany()
