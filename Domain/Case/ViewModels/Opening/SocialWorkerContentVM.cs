...
namespace CanLove_Backend.Domain.Case.ViewModels.Opening
{
    ...
    public class SocialWorkerContentVM : ICaseWizardVM
    {
        ...
        // 選項資料
        public List<CanLove_Backend.Infrastructure.Options.Models.OptionSetValue> ResidenceTypeOptions { get; set; } = new List<CanLove_Backend.Infrastructure.Options.Models.OptionSetValue>();
    }
}
