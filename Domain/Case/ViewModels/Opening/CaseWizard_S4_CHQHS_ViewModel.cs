...
namespace CanLove_Backend.Domain.Case.ViewModels.Opening
{
    ...
    public class CaseWizard_S4_CHQHS_ViewModel : ICaseWizardViewModel
    {
        ...
        // 選項資料
        public List<CanLove_Backend.Infrastructure.Options.Models.OptionSetValue> CaregiverRoleOptions { get; set; } = new List<CanLove_Backend.Infrastructure.Options.Models.OptionSetValue>();
    }
}
