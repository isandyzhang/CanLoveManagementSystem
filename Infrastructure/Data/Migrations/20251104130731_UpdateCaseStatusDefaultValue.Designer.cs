...
namespace CanLove_Backend.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251104130731_UpdateCaseStatusDefaultValue")]
    partial class UpdateCaseStatusDefaultValue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseConsultationRecord", b =>
                {
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseEqemotionalEvaluation", b =>
                {
                    b.Property<string>("CaseId")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)")
                    ...
                    b.HasIndex(new[] { "OpeningId" }, "IX_CaseEQemotionalEvaluation_opening_id")
                        .HasDatabaseName("IX_CaseEQemotionalEvaluation_opening_id1");
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseFamilyMember", b =>
                {
                    b.Property<string>("CaseId")
                        .IsRequired()
                        .HasMaxLength(10)
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseFqeconomicStatus", b =>
                {
                    b.Property<string>("CaseId")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)")
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseHqhealthStatus", b =>
                {
                    ...
                    b.HasIndex(new[] { "OpeningId" }, "IX_CaseHQhealthStatus_opening_id");
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseIqacademicPerformance", b =>
                {
                    b.Property<string>("CaseId")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)")
                    ...
                    b.HasIndex(new[] { "OpeningId" }, "IX_CaseIQacademicPerformance_opening_id")
                        .HasDatabaseName("IX_CaseIQacademicPerformance_opening_id1");
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseOpening", b =>
                {
                    b.Property<int>("OpeningId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OpeningId"));
                    ...
                    b.HasIndex(new[] { "Status" }, "IX_CaseOpening_Status");

                    b.HasIndex(new[] { "CaseId" }, "UQ_CaseOpening_CaseId")
                        .IsUnique();

                    b.ToTable("CaseOpening", null, t =>
                        {
                            t.HasTrigger("TR_CaseOpening_UpdateTime");
                        });

                    b.HasAnnotation("SqlServer:UseSqlOutputClause", false);
                });

            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseSocialWorkerContent", b =>
                {
                    b.Property<string>("CaseId")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)")
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseSocialWorkerService", b =>
                {
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.FinalAssessmentSummary", b =>
                {
                    ...
                    b.HasIndex(new[] { "OpeningId" }, "IX_FinalAssessmentSummary_opening_id")
                        .HasDatabaseName("IX_FinalAssessmentSummary_opening_id1");
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Basic.BlobStorage", b =>
                {
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Basic.Staff", b =>
                {
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Shared.Models.City", b =>
                {
                    b.Property<int>("CityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Shared.Models.FamilyStructureType", b =>
                {
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Shared.Models.Nationality", b =>
                {
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Shared.Models.OptionSet", b =>
                {
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Shared.Models.OptionSetValue", b =>
                {
            ...
            modelBuilder.Entity("CanLove_Backend.Data.Models.Review.CaseReviewItem", b =>
                {
                    ...
                    b.HasIndex(new[] { "CaseId" }, "IX_CaseReviewItem_CaseId");

                    b.HasIndex(new[] { "Status" }, "IX_CaseReviewItem_Status");

                    b.HasIndex(new[] { "Type", "Status" }, "IX_CaseReviewItem_Type_Status");

                    b.ToTable("CaseReviewItem", (string)null);
                });

            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseConsultationRecord", b =>
                {
                    b.HasOne("CanLove_Backend.Domain.Case.Models.Basic.Case", "Case")
                        .WithMany("CaseConsultationRecords")
                        .HasForeignKey("CaseId")
                        .IsRequired()
                        .HasConstraintName("FK__CaseConsu__caseI__5BAD9CC8");

                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.OptionSetValue", "ConsultationMethodValue")
                    ...
                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.OptionSetValue", "ConsultationTargetValue")
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseDetail", b =>
                {
                    b.HasOne("CanLove_Backend.Domain.Case.Models.Basic.Case", "Case")
                        .WithOne("CaseDetail")
                        .HasForeignKey("CanLove_Backend.Domain.Case.Models.Opening.CaseDetail", "CaseId")
                        .IsRequired()
                        .HasConstraintName("FK__CaseDetai__caseI__06CD04F7");

                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.OptionSetValue", "ContactRelationValue")
                    ...
                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.FamilyStructureType", "FamilyStructureType")
                        .WithMany("CaseDetails")
                        .HasForeignKey("FamilyStructureTypeId")
                        .HasConstraintName("FK__CaseDetai__famil__08B54D69");

                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.OptionSetValue", "HelpExperienceValue")
                    ...
                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.OptionSetValue", "MainCaregiverEduValue")
                    ...
                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.OptionSetValue", "MainCaregiverMarryStatusValue")
                    ...
                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.OptionSetValue", "MainCaregiverRelationValue")
                    ...
                    b.HasOne("CanLove_Backend.Domain.Case.Models.Opening.CaseOpening", "CaseOpening")
                        .WithOne("CaseDetail")
                        .HasForeignKey("CanLove_Backend.Domain.Case.Models.Opening.CaseDetail", "OpeningId")
                        .IsRequired()
                        .HasConstraintName("FK_CaseDetail_CaseOpening");

                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.Nationality", "ParentNationFather")
                        .WithMany("CaseDetailParentNationFathers")
                        .HasForeignKey("ParentNationFatherId")
                        .HasConstraintName("FK__CaseDetai__paren__09A971A2");

                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.Nationality", "ParentNationMother")
                        .WithMany("CaseDetailParentNationMothers")
                        .HasForeignKey("ParentNationMotherId")
                        .HasConstraintName("FK__CaseDetai__paren__0A9D95DB");

                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.OptionSetValue", "SourceValue")
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseEqemotionalEvaluation", b =>
                {
                    b.HasOne("CanLove_Backend.Domain.Case.Models.Basic.Case", "Case")
                        ...
                        .HasForeignKey("CanLove_Backend.Domain.Case.Models.Opening.CaseEqemotionalEvaluation", "CaseId")
                        .IsRequired()
                        .HasConstraintName("FK__CaseEQemo__caseI__3E1D39E1");

                    b.HasOne("CanLove_Backend.Domain.Case.Models.Opening.CaseOpening", "CaseOpening")
                        .WithOne("CaseEqemotionalEvaluation")
                        .HasForeignKey("CanLove_Backend.Domain.Case.Models.Opening.CaseEqemotionalEvaluation", "OpeningId")
                        .IsRequired()
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseFamilyMember", b =>
                {
                    ...
                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.OptionSetValue", "MemberTypeValue")
                        .WithMany()
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseFamilySpecialStatus", b =>
                {
                    ...
                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.OptionSetValue", "StatusTypeValue")
                        .WithMany()
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseFqeconomicStatus", b =>
                {
                    b.HasOne("CanLove_Backend.Domain.Case.Models.Basic.Case", "Case")
                        ...
                        .HasForeignKey("CanLove_Backend.Domain.Case.Models.Opening.CaseFqeconomicStatus", "CaseId")
                        .IsRequired()
                        .HasConstraintName("FK__CaseFQeco__caseI__208CD6FA");

                    b.HasOne("CanLove_Backend.Domain.Case.Models.Opening.CaseOpening", "CaseOpening")
                        .WithOne("CaseFqeconomicStatus")
                        .HasForeignKey("CanLove_Backend.Domain.Case.Models.Opening.CaseFqeconomicStatus", "OpeningId")
                        .IsRequired()
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseHqhealthStatus", b =>
                {
                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.OptionSetValue", "CaregiverRoleValue")
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseIqacademicPerformance", b =>
                {
                    b.HasOne("CanLove_Backend.Domain.Case.Models.Basic.Case", "Case")
                        ...
                        .HasForeignKey("CanLove_Backend.Domain.Case.Models.Opening.CaseIqacademicPerformance", "CaseId")
                        .IsRequired()
                        .HasConstraintName("FK__CaseIQaca__caseI__31B762FC");

                    b.HasOne("CanLove_Backend.Domain.Case.Models.Opening.CaseOpening", "CaseOpening")
                        .WithOne("CaseIqacademicPerformance")
                        .HasForeignKey("CanLove_Backend.Domain.Case.Models.Opening.CaseIqacademicPerformance", "OpeningId")
                        .IsRequired()
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseOpening", b =>
                {
                    b.HasOne("CanLove_Backend.Domain.Case.Models.Basic.Case", "Case")
                        .WithOne()
                        .HasForeignKey("CanLove_Backend.Domain.Case.Models.Opening.CaseOpening", "CaseId")
                        .IsRequired()
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseSocialWorkerContent", b =>
                {
                    b.HasOne("CanLove_Backend.Domain.Case.Models.Basic.Case", "Case")
                        ...
                        .HasForeignKey("CanLove_Backend.Domain.Case.Models.Opening.CaseSocialWorkerContent", "CaseId")
                        .IsRequired()
                        .HasConstraintName("FK__CaseSocia__caseI__19DFD96B");

                    b.HasOne("CanLove_Backend.Domain.Case.Models.Opening.CaseOpening", "CaseOpening")
                        .WithOne("CaseSocialWorkerContent")
                        .HasForeignKey("CanLove_Backend.Domain.Case.Models.Opening.CaseSocialWorkerContent", "OpeningId")
                        .IsRequired()
                        .HasConstraintName("FK_CaseSocialWorkerContent_CaseOpening");

                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.OptionSetValue", "ResidenceTypeValue")
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.CaseSocialWorkerService", b =>
                {
                    ...
                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.OptionSetValue", "ServiceTypeValue")
                        .WithMany("CaseSocialWorkerServices")
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Opening.FinalAssessmentSummary", b =>
                {
                    b.HasOne("CanLove_Backend.Domain.Case.Models.Basic.Case", "Case")
                        ...
                        .HasForeignKey("CanLove_Backend.Domain.Case.Models.Opening.FinalAssessmentSummary", "CaseId")
                        .IsRequired()
                        .HasConstraintName("FK__FinalAsse__caseI__43D61337");

                    b.HasOne("CanLove_Backend.Domain.Case.Models.Opening.CaseOpening", "CaseOpening")
                        .WithOne("FinalAssessmentSummary")
                        .HasForeignKey("CanLove_Backend.Domain.Case.Models.Opening.FinalAssessmentSummary", "OpeningId")
                        .IsRequired()
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Basic.BlobStorage", b =>
                {
                    b.HasOne("CanLove_Backend.Domain.Case.Models.Basic.Staff", "Uploader")
                        .WithMany()
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Models.Basic.Case", b =>
                {
                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.City", "City")
                        .WithMany("Cases")
                        .HasForeignKey("CityId")
                        .HasConstraintName("FK__Cases__city_id__00200768");

                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.District", "District")
                        .WithMany("Cases")
                        .HasForeignKey("DistrictId")
                        .HasConstraintName("FK__Cases__district___01142BA1");

                    b.HasOne("CanLove_Backend.Domain.Case.Models.Basic.BlobStorage", "PhotoBlob")
                        .WithMany()
                        .HasForeignKey("PhotoBlobId")
                        .HasConstraintName("FK_Cases_PhotoBlob");

                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.School", "School")
                        .WithMany("Cases")
            ...
            modelBuilder.Entity("CanLove_Backend.Domain.Case.Shared.Models.OptionSetValue", b =>
                {
                    b.HasOne("CanLove_Backend.Domain.Case.Shared.Models.OptionSet", "OptionSet")
